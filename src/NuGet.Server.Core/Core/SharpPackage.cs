...
{
    public class SharpPackage : LocalPackage
    {
        ...
        protected new void ReadManifest(Stream manifestStream)
        {
            ...
            var metadata = XmlSerializerHelper.LoadObjectFromXmlString<CnSharp.Updater.Manifest>(xml);
        ...
        #region Overrides of LocalPackage
