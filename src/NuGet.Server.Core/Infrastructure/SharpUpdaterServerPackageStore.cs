...
{
    public class SharpUpdaterServerPackageStore
        : IServerPackageStore
    {
        private readonly IFileSystem _fileSystem;
        private readonly SharpUpdaterExpandedPackageRepository _repository;
        private readonly NuGet.Server.Core.Logging.ILogger _logger;

        public SharpUpdaterServerPackageStore(
            IFileSystem fileSystem,
            SharpUpdaterExpandedPackageRepository repository,
            NuGet.Server.Core.Logging.ILogger logger)
        {
