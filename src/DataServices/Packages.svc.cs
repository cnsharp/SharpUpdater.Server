...
namespace CnSharp.Updater.Server.DataServices
{
    ...
    public class Packages : DataService<PackageContext>, IDataServiceStreamProvider, IServiceProvider
    {
        ...
        [WebGet]
        public IQueryable<ODataPackage> GetUpdates(string packageIds, string versions, bool includePrerelease)
        {
            return GetUpdates(packageIds, versions, includePrerelease, false, null, null);
        }

        IQueryable<ODataPackage> GetUpdates(
