...
namespace CnSharp.Updater.Server.Publishing
{
    public class PackageService : IPackageService
    {
        private const string ApiKeyHeader = "X-SHARPUPDATER-APIKEY";
        ...
        public void CreatePackage(HttpContextBase context)
        {
            ...
            var package = new SharpPackage(stream);
        ...
        public void DownloadPackage(HttpContextBase context)
        {
            ...
            if (requestedPackage != null)
            {
                context.Response.AddHeader("content-disposition", 
                    string.Format("attachment; filename={0}.{1}{2}", requestedPackage.Id, requestedPackage.Version.ToNormalizedString(),Strings.PackageExt));
